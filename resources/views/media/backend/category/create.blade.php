...
@include('dashboard.common.breadcrumb',['name' => 'Danh mục media','key'=> 'Thêm mới'])

<section class="content">
    <form role="form" action="{{route('mediaCategory.store')}}" method="post">
                ...
                <div class="box box-warning">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <?php
                            echo Form::select('layoutid', config('media'), null, ['class' => 'form-control']);
                            ?>
