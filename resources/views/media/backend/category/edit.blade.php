...
@include('dashboard.common.breadcrumb',['name' => 'Danh mục bài viết','key'=> 'Cập nhập'])

<section class="content">
    <form role="form" action="{{route('mediaCategory.update',['id' => $detail->id])}}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="box box-warning">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <?php
                            echo Form::select('parentid', $htmlCatalogue, $detail->parentid, ['class' => 'form-control']);
                            ?>
                        </div>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
                <div class="box box-warning">
                    <div class="box-body">
                        <div class="form-group">
                            <label>Loại thư viện</label>
                            <?php
                            echo Form::select('layoutid', config('media'), $detail->layoutid, ['class' => 'form-control']);
                            ?>
