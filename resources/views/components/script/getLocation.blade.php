<script>
    ...
    var districtid = '<?php echo !empty(old('districtid'))?old('districtid'):(!empty($detail->districtid)?$detail->districtid:"") ?>';
    ...
    function getLocation(param, object) {
        ...
        let formURL = '<?php echo route('components.getLocation') ?>';
        $.post(formURL, {
                param: param,
