            ...
            <div class="flex-1 p-4 md:p-10">
                ...
                <section>
                    ...
                    <div class="grid gap-4 md:grid-cols-4 grid-cols-2">
                        <a href="" target="_blank" class="border rounded-lg p-2 cursor-pointer hover:bg-gray-100">
        ...
        <div class="block md:flex lg:flex mt-8 t-card md:h-[234px] lg:h-[234px]  bg-white md:shadow md:rounded-2xl">
            ...
            <div class="md:w-1/2 lg:w-1/2 w-full relative">
                <div class="owl-carousel-banner owl-carousel owl-theme">
                    <div class="item">
                        <a href="#">
                            <img class="md:rounded-tr-2xl md:rounded-br-2xl lg:rounded-tr-2xl lg:rounded-br-2xl h-[234px]" src="https://media-api-beta.thinkpro.vn/media/core/banners/2022/3/3/PC ĐỒNG ĐỘ.png" alt=""></a>
                    </div>
                    <div class="item">
                        <img class="md:rounded-tr-2xl md:rounded-br-2xl lg:rounded-tr-2xl lg:rounded-br-2xl h-[234px]" src="https://media-api-beta.thinkpro.vn/media/core/banners/2022/3/3/PC ĐỒNG ĐỘ.png" alt=""></a>
                    </div>
...
<script>
    $('.ovn_category_item.active').next().addClass("rounded-tr-2xl");
    $('.ovn_category_item').click(function() {
        $('.ovn_category_item').removeClass('first_section').removeClass('active').removeClass('rounded-br-2xl').removeClass("rounded-tr-2xl");
        $(this).addClass('active');
        $(this).prev().addClass("rounded-br-2xl");
        $(this).next().addClass("rounded-tr-2xl");
    ...
    $('.hide_userInfo').click(function() {
        $('.hide_userInfo').hide();
    })
    $('.ovn_keyword').keyup(function() {
        $('.ovn_submit_search').show();
    })
</script>
<script>
    ...
    $('.owl-carousel-catalogue').owlCarousel({
        margin: 10,
        nav: true,
        dots: false,
        loop: false,
