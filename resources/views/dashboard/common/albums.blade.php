        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($album) && is_array($album) && count($album)) {
                    ...
                    $gallery = json_decode($detail->image_json, TRUE);
                }
                ?>
...
<script>
    ...
    function openKCFinderImage(button) {
        window.KCFinder = {
            callBackMultiple: function(files) {
                ...
                for (var i = 0; i < files.length; i++) {
                    $(".upload-list .row #sortable").prepend(
                        image_render(files[i])
                    );
        ...
        window.open(
            BASE_URL +
            "plugin/kcfinder-3.12/browse.php?type=images&dir=images/public",
            "kcfinder_image",
