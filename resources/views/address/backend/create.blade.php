...
@include('dashboard.common.breadcrumb',['name' => 'Thêm mới cửa hàng','key'=> 'Thêm mới'])

<section class="content">
    <form role="form" action="{{route('address.store')}}" method="post">
                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            echo Form::text('hotline', '', ['class' => 'form-control']);
                            ?>
                        </div>
                        <div class="form-group">
                            <label>Địa chỉ</label>
                            <?php
                            echo Form::text('address', '', ['class' => 'form-control','placeholder'=>'Số 33 ngõ 629 Kim Mã']);
                            ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            echo Form::select('cityid', $listCity, '', ['class' => 'form-control select3', 'id' => 'city']);
                            ?>
                        </div>
                        <div class="form-group">
